...
texiao:loadTexture("game/tiger/image/texiao.png",0)
...
texiao:setVisible(false)
texiao:setPosition(640.0000, 360.0000)
...
--Create jineng
local jineng = ccui.Button:create()
jineng:ignoreContentAdaptWithSize(false)
jineng:loadTextureNormal("game/tiger/image/jineng.png",0)
jineng:setTitleFontSize(14)
jineng:setTitleColor({r = 65, g = 65, b = 70})
jineng:setScale9Enabled(true)
jineng:setCapInsets({x = 15, y = 11, width = 81, height = 90})
jineng:setLayoutComponentEnabled(true)
jineng:setName("jineng")
jineng:setTag(53)
jineng:setCascadeColorEnabled(true)
jineng:setCascadeOpacityEnabled(true)
jineng:setPosition(1191.8430, 70.2041)
layout = ccui.LayoutComponent:bindLayoutComponent(jineng)
layout:setPositionPercentX(0.9311)
layout:setPositionPercentY(0.0975)
layout:setPercentWidth(0.0867)
layout:setPercentHeight(0.1556)
layout:setSize({width = 111.0000, height = 112.0000})
layout:setLeftMargin(1136.3430)
layout:setRightMargin(32.6574)
layout:setTopMargin(593.7959)
layout:setBottomMargin(14.2041)
Scene:addChild(jineng)
